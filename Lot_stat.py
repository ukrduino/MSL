...
print("Количество выиграшных комбинаций из всех четных/нечетных шаров - %s (%s)" % (odd_even, odd_even/comb*100))
print("Количество выиграшных комбинаций из 5 четных / 1 нечетных шаров - %s (%s)" % (odd5_even1, odd5_even1/comb*100))
print("Количество выиграшных комбинаций из 4 четных / 2 нечетных шаров - %s (%s)" % (odd4_even2, odd4_even2/comb*100))
print("Количество выиграшных комбинаций из 3 четных / 3 нечетных шаров - %s (%s)" % (odd3_even3, odd3_even3/comb*100))
